        ...
        <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="r-inner-h4 form-control" name="emp_code"
                               value="<?if( isset($select[$_SESSION['emp_code']][0]->employee)): echo  $select[$_SESSION['emp_code']][0]->employee ; endif;?>"
                               readonly="" />
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="control-label">المسمي الوظيفي</label>
                        <input type="text" class="r-inner-h4 form-control" name=""  readonly value="<? if(!empty($select[$_SESSION['emp_code']][0]->department) && isset($select[$_SESSION['emp_code']][0]->department)): echo $job_title[$select[$_SESSION['emp_code']][0]->department][0]->name; endif;?>">
                    </div>
                </div>
