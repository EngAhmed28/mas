...
<?php echo form_open_multipart('Edit_fatora/edit_fatora',array('class'=>"form-horizontal",'role'=>"form" ))?>
...
<div class="well bs-component"  style="padding-bottom: 500px;" >
    ...
    <div class="col-lg-6">
            <div class="form-group" >
                <label for="inputUser"  class="control-label">قم بإختيار المريض:</label>
...
<script>
    function account(account_code)
    {
        ...
        if(account_code)
        {
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>/Edit_fatora/index',
                data:dataString,
                dataType: 'html',
                cache:false,
