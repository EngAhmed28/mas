    ...
    if(isset($_SESSION["order_addtion".$session_id]) && count($_SESSION["order_addtion".$session_id])>0){ //if we have session variable
        ...
        $table .= ' <tr>
                    ...
                    <div class="col-xs-10 r-input">
                        <input type="text" class="form-control" name="order_notes" value="'.$note.'" id="order_notes" required />
                    </div>
                    ...
                    <div class="col-xs-12 r-inner-btn" style="padding-top: 20px;">
                        ...
                        <input type="submit" role="button" name="save" value="حفظ أمر التوريد" class="btn btn-primary col-lg-12" />
                    </div>
