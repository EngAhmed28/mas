...
<h2 class="text-flat">إدارة الإنجازات <span class="text-sm"><?php echo $title; ?></span></h2>
...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/update_achieve/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                <label for="inputUser" class="col-lg-2 control-label">تاريخ العرض</label>
                <div class="col-lg-10 input-grup">

                    <input type="date" id="news_date"   value="<?php echo $result['date']; ?>" name="news_date" class="form-control text-right" placeholder="تاريخ العرض">
            ...
            <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="text" id="news_name" value="<?php echo $result['title']; ?>" name="news_name" class="form-control text-right" placeholder="   عنوان العرض">
            ...
            <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                <label for="inputUser" class="col-lg-2 control-label">صور العرض:</label>
                ...
                for($x = 0 ; $x < count($photo) ; $x++){
                    if(count($photo) > 1)
                    {
                        $td = '<td style="padding-top: 10%px;">
                               <a  href="'.base_url().'dashboard/delete_photo_achieve/'.$result['id'].'/'.$x.'"  class="btn btn-danger btn-xs col-lg-12">
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/add_achieve',array('class'=>"form-horizontal",'role'=>"form" ))?>
        <fieldset>
     ...
     <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="date" id="news_date"  name="news_date" class="form-control text-right" placeholder="تاريخ العرض" required>
            ...
            <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="text" id="news_name"  name="news_name" class="form-control text-right" placeholder="عنوان العرض" required>
...
<?php if(isset($records)&&$records!=null):?>
    ...
    <table id="no-more-tables" class="table table-bordered" role="table">
        ...
        <tr>
            ...
            <th width="15%" class="text-right">حالة العرض</th>
        ...
        ?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/update_achieve/'.$record->id?>" class="btn btn-warning btn-xs col-lg-3"><i class="fa fa-pencil"></i> تعديل</a>

                    <a  href="<?php echo base_url().'dashboard/delete_achieve/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-3"><i class="fa fa-trash"></i> حذف</a>

                </td>
                
                <td data-title="" class="text-center">

                    <a href="<?php echo base_url().'dashboard/suspend_achieve/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-6"><?php echo $title ?> </a>
 ...
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="gridSystemModalLabel">إدارة العروض</h4>
      </div>
      <br />
        <div class="col-sm-3" style="font-size: 16px;">تاريخ العرض</div>
          <div class="col-sm-9"  style="font-size: 16px;">
            <?php echo $record->date?>
          </div>
      <br /><br />
        <div class="col-sm-3" style="font-size: 16px;">عنوان العرض</div>
          <div class="col-sm-9"  style="font-size: 16px;">
      ...
      <div class="col-sm-2" style="font-size: 16px;">صور العرض</div>
      <div class="col-sm-10">
        <div class="row">
  ...
  <br/><br /> 
        ...
        <br /><br />
        <div class="row">
        <div class="col-sm-4" style="font-size: 16px;">تفاصيل العرض</div>
          <div class="col-sm-8">
...
<script>
 function lood(num){
    if(num>0 && num != '')
    {
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>/dashboard/add_achieve',
            data:dataString,
            dataType: 'html',
            cache:false,
