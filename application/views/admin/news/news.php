...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/update_news/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
                ...
                for($x = 0 ; $x < count($photo) ; $x++){
                    if(count($photo) > 1)
                    {
                        $td = '<td style="padding-top: 10%px;">
                               <a  href="'.base_url().'dashboard/delete_photo/'.$result['id'].'/'.$x.'"  class="btn btn-danger btn-xs col-lg-12">
        ...
        ?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/update_news/'.$record->id?>" class="btn btn-warning btn-xs col-lg-3"><i class="fa fa-pencil"></i> تعديل</a>

                    <a  href="<?php echo base_url().'dashboard/delete_news/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-3"><i class="fa fa-trash"></i> حذف</a>

                </td>
                
                <td data-title="" class="text-center">

                    <a href="<?php echo base_url().'dashboard/suspend_news/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-6"><?php echo $title ?> </a>
