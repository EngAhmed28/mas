...
echo '<div class="col-xs-12">
      ...
      <div class="col-xs-1">
      <input type="text" style="height:10px;width:85px;color:red;" id="same'.$dis.'" class="form-control" readonly value="'.sprintf("%.2f",(($records4[key($records4)][key($records4[key($records4)])][$s]->operation_price - $records4[key($records4)][key($records4[key($records4)])][$s]->discount_op  ) - $records4[key($records4)][key($records4[key($records4)])][$s]->paid)).'" />
      </div>
      <div class="col-xs-2 text-left"  style="padding-left:30px;">
      <input type="text" style="height:10px;width:85px;" name="after_dis'.$dis.'" id="after_dis'.$dis.'" class="form-control" readonly value="'.sprintf("%.2f",( ($records4[key($records4)][key($records4[key($records4)])][$s]->operation_price - $records4[key($records4)][key($records4[key($records4)])][$s]->discount_op  ) -$records4[key($records4)][key($records4[key($records4)])][$s]->paid)).'" />
      </div>
  </div>';
   $total += $records4[key($records4)][key($records4[key($records4)])][$s]->operation_price - $records4[key($records4)][key($records4[key($records4)])][$s]->discount_op  ;
