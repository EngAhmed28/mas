        ...
        <div class="col-xs-12">
                <div class="details-resorce">
                    <div class="col-xs-12 r-bottom">
                        <div class="panel-heading">
                            <div id="bc1" class="">
                               <a   class="btn btn-sm btn-info" onclick="return go('current')" >الأذونات الواردة</a>
                               <a  class="btn btn-sm btn-info" onclick="return go(1)" >الأذونات الموافق عليها</a>
                               <a   class="btn btn-sm btn-info" onclick="return go(2)" >الأذونات المرفوضة</a>
                            </div>
                        </div>
                ...
                <div id="optionareav">
                    <div class="details-resorce">
                        ...
                        <div>
                            <table id="no-more-tables" style="width: 300px;margin-bottom: -22px;margin-right: 32%;margin-bottom: 5px" class="table table-bordered" role="table" >
                                <thead>
                                <tr>
                                                        ...
                                                        <div class="modal fade" id="myModal-<?php echo $row->permit_num; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content" >
                                                                    ...
                                                                    <?php echo form_open_multipart('Administrative_affairs/suspendreports/',array('class'=>"form-horizontal",'role'=>"form" ))?>
