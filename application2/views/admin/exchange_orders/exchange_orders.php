            ...
            <div class="col-md-4">
                <div class="layout">
                    <div class="form-group ">
                        <label>رقم التوريد:</label>
                        <input type="text" value="<?php if(!(isset($result))){if(isset($count) && $count != null) echo ($count[0]->id+1); else echo 1;}else echo $id; ?>" class="form-control col-xs-6 no-padding" name="order_num" id="order_num" readonly />
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="layout">
                    <div class="form-group ">
                        ...
                        <input type="date" class="form-control" name="date" <?php if(isset($result)) {echo 'value="'.date("m/d/Y",$result['date']).'"'; echo "disabled";} ?> id="date" required>
                    </div>
                </div>
            </div>
                ...
                <div class="layout">
                    <div class="form-group ">
                        ...
                        <select name="donar_id_fk" id="donar_id_fk" onchange="$('#donar_id_fk2').val($('#donar_id_fk').val());)" class="selectpicker no-padding form-control" data-show-subtext="true" data-live-search="true" required>
                            ...
                            <?php
                            if(isset($donors))
                                foreach($donors as $doner){
                                    $selected = '';
                                    if(isset($result) && $doner->code == $result['donar_id_fk'])
                                        $selected = 'selected';
                                    echo '<option value="'.$doner->code.'" '.$selected.'>'.$doner->name.'</option>';
                                }
                            ?>
                        </select>
                    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="layout">
                    <div class="form-group ">
                        <label>الكمية:</label>
                        <input type="text" onkeyup="return diving();" onkeypress="return isNumberKey(event)" class="form-control col-xs-6 no-padding" name="product_amount" id="product_amount" required />
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="layout">
                    <div class="form-group ">
                        <label>سعر تكلفة الكمية:</label>
                        <input type="text" onkeyup="return diving();" onkeypress="return isNumberKey(event)" class="form-control col-xs-6 no-padding" name="all_cost_exchange" id="all_cost_exchange" required />
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="layout">
                    <div class="form-group ">
                        ...
                        <input type="text" value="0" class="form-control col-xs-6 no-padding" name="one_cost" id="one_cost" readonly />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="layout">
                    <div class="form-group ">
                        ...
                        <input type="submit" role="button" name="add" value="إضافة الصنف" onclick="return session(<?php echo $id; ?>);" class="btn btn-primary col-lg-12" />
                    </div>
                </div>
            </div>
        </div>
