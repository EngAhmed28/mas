...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/updateabout_almas/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        ?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/updateabout_almas/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>

                    <a  href="<?php echo base_url().'dashboard/deleteabout_almas/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>

                </td>
                
                <td data-title="حالة المقطع" class="text-center">

                    <a href="<?php echo base_url().'dashboard/suspendAbout_almas/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-5"><?php echo $title ?> </a>
