...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
 ...
 <fieldset>
            ...
            <legend data-sr="wait 0.3s, then enter left and hustle 100%">البايانات الشخصية</legend>
...
<div class="well bs-component" data-sr="wait 0.6s, then enter left and hustle 100%" style="padding: 0px 10px;">
 <fieldset>
...
<div class="well bs-component" data-sr="wait 0.6s, then enter left and hustle 100%">
 <fieldset>
...
<input type="number" class="form-control text-center" value="" step="any" name="first_paid" required="required" />		        
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/patient',array('class'=>"form-horizontal",'role'=>"form" ))?>
            <section class="col-md-9 col-xs-12">
	<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
        <fieldset>
