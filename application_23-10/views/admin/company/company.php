...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/update_company/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                <label for="inputUser" class="col-lg-2 control-label">إسم الشركة:</label>
                <div class="col-lg-10 input-grup">
                    <i class="fa fa-user"></i>

                    <input type="text" id="name"  value="<?php echo $result['name']; ?>" name="name" class="form-control text-right" placeholder="   إسم الشركة" required>
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/add_company',array('class'=>"form-horizontal",'role'=>"form" ))?>
        <fieldset>
            ...
            <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                ...
                <i class="fa fa-user"></i>
                    ...
                    <input type="text" id="name"  name="name" class="form-control text-right" placeholder=" إسم الشركة" required>
...
<?php if(isset($records)&&$records!=null):?>
    ...
    <table id="no-more-tables" class="table table-bordered" role="table">
        ...
        <tr>
            ...
            <th class="text-right">حالة الشركة</th>
        ...
        ?>
            <tr>
                ...
                <td  data-title=""><?php echo word_limiter($record->content,3)?></td>

                <td data-title="التحكم" class="text-center">

                    <a href="<?php echo base_url().'dashboard/update_company/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>

                    <a  href="<?php echo base_url().'dashboard/delete_company/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>

                </td>
                
                <td data-title="" class="text-center">

                    <a href="<?php echo base_url().'dashboard/suspend_company/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-6"><?php echo $title ?> </a>
