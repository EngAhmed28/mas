                ...
                <table style="width:100%">
                    ...
                    for($x = 0 ; $x < count($records[key($records)]) ; $x++){
                        echo '<tr>
                              ...
                              <td>'.$records[key($records)][$x]->opretion_amuont.'</td>
                              <td>'.$records[key($records)][$x]->discount.'%</td>
                              <td>'.sprintf('%.2f',($records[key($records)][$x]->operation_price * $records[key($records)][$x]->opretion_amuont - $records[key($records)][$x]->discount) ).'</td>
                              </tr>';
                              
                        $money += ($records[key($records)][$x]->operation_price * $records[key($records)][$x]->opretion_amuont - $records[key($records)][$x]->discount);
                    ...
                    <tr class="result">
                        <td colspan="4" class="text-center"> الإجمـــــــالي </td>
                        <td class="text-center"> <?php echo sprintf('%.2f',$money) ?> </td>
                    </tr>
                    <tr class="result">
                        <td colspan="2" class="text-center"> المبلغ المدفوع </td>
                        <td class="text-center"> <?php echo sprintf('%.2f',$fatora[0]->sub_fat[0]->paid) ?> </td>
                        <td class="text-center"> المتبقى  </td>
                        <td class="text-center"> <?php echo sprintf('%.2f',($fatora[0]->sub_fat[0]->remain)) ?> </td>
                    </tr>
                </table>
            </div>
            <div class="col-xs-12">
