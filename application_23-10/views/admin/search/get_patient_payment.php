...
document.getElementById('button2').style.display='none';
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a  title="موافق" style="float:right">
                            <button   id="button" onclick="mufunc1();"  class="btn btn-success btn-xs " >موافق</button>
                            <button   id="button2" onclick="mufunc2();"  class="btn btn-danger btn-xs ">رفض</button>
