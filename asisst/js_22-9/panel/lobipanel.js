...
//------------------------------------------------------------------------------
    ...
    $.fn.lobiPanel.DEFAULTS = {
        ...
        unpin: {
            ...
            tooltip: 'تحريك'               //tooltip text, If you want to disable tooltip, set it to false
        },
        reload: {
            icon: 'glyphicon glyphicon-refresh', //You can user glyphicons if you do not want to use font-awesome
            tooltip: 'إعادة تحميل'           //tooltip text, If you want to disable tooltip, set it to false
        },
        minimize: {
            ...
            tooltip: 'تصغير'         //tooltip text, If you want to disable tooltip, set it to false
        },
        expand: {
            ...
            tooltip: 'تكبير'       //tooltip text, If you want to disable tooltip, set it to false
        },
        close: {
            icon: 'glyphicon glyphicon-remove', //You can user glyphicons if you do not want to use font-awesome
            tooltip: 'إغلاق'            //tooltip text, If you want to disable tooltip, set it to false
        },
        editTitle: {
